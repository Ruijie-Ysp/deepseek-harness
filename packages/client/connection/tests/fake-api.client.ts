...
export class FakeApiClient implements IApiClient {
  ...
  onEditPrompt: (payload: unknown) => Promise<RpcResponse<{ accepted: true }>> = () => Promise.resolve(ok({ accepted: true as const }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    editPrompt: (payload: unknown) => this.record('session.editPrompt', payload, this.onEditPrompt(payload)),
