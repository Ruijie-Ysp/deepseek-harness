...
export const zh = {
  ...
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'edit.banner': '正在编辑历史消息，发送后将重新生成回复',
  'edit.cancel': '取消编辑',
  'edit.failed': '编辑提交失败',
  'edit.imagesUnsupported': '编辑历史消息不支持添加图片',
...
export const en = {
  ...
  'edit.banner': 'Editing a past message — sending will regenerate the reply',
  'edit.cancel': 'Cancel edit',
  'edit.failed': 'Edit submission failed',
  'edit.imagesUnsupported': 'Adding images is not supported when editing a message',
