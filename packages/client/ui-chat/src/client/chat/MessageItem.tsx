...
function UserStyleBubble({
  content, renderMessageImages, actions, pending = false, echo = false, edited = false, referenceLabels = [], skillNames = [],
...
export const UserMessageNodeView = memo(function UserMessageNodeView({
  node, renderMessageImages, inputActions, openFile, openSkill, t,
