...
export interface MessageIconActionsProps {
  ...
  /** Rewrite this message in place; omission hides the edit action. */
...
export function MessageIconActions({
  text, time, runMs, ttftMs, tokensPerSecond, clock, onBranch, onEdit, branchUnavailable = false, className,
  extraActions, t,
