...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote(\'editPrompt\') editPrompt(request: SessionEditPromptRequest, signal: AbortSignal): Promise<SessionEditPromptValue>',
        description: 'Rewrite one settled user message after explicitly resuming its Session.',
        parameters: [{ name: 'request', description: 'Session identity, the targeted surface seq, and replacement text.' }, { name: 'signal', description: 'caller cancellation before the rewrite is admitted.' }],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'SessionEditPromptRequest',
    declaration: 'export interface SessionEditPromptRequest {\n    readonly requestId: SessionRequestId;\n    readonly sessionId: SessionId;\n    readonly atSeq: number;\n    readonly content: readonly {\n        readonly type: \'text\';\n        readonly text: string;\n    }[];\n    readonly clientTimeZone?: string;\n}',
  },
  {
    name: 'SessionEditPromptValue',
    declaration: 'export interface SessionEditPromptValue {\n    readonly accepted: true;\n}',
  },
  {
    name: 'SessionEvent',
  ...
  },
  {
    ...
    declaration: 'export type SurfaceEventType = \'system/message\' | \'user/message\' | \'user/edit\' | \'assistant/message\' | \'tool/result\';',
  },
  {
    name: 'SurfaceIntent',
  ...
  {
    name: 'UserEditEvent',
    declaration: 'export interface UserEditEvent {\n    message: UserMessage;\n    replacesSeq: number;\n}',
  },
  {
    name: 'UserMessage',
